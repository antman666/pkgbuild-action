...
pacman -Syu --noconfirm --needed base-devel pacman-contrib wget ccache jemalloc
wget -c https://www.archlinux.club/x86_64/llvm+clang-14.0.6-1-x86_64.pkg.tar.zst
wget -c https://www.archlinux.club/x86_64/libclc+clang-14.0.6-1-any.pkg.tar.zst
